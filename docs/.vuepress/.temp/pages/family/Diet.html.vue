<template><div><p>早餐：燕麦牛奶 + 坚果、桃李面包 + 鲜牛奶。</p>
<p>坚果：每天 3 个纸核桃。</p>
<p>午餐：沙拉 + 鸡蛋 + 白肉（鸡、鸭、鱼）。</p>
<p>晚上：6 点停止进食，饿了吃苹果、沙拉、鸡蛋，鸡蛋只吃蛋白。</p>
<p>16:8 断时法：每天 8 小时进食，8 点钟早餐，3 点后禁食。</p>
<h2 id="饮料" tabindex="-1"><a class="header-anchor" href="#饮料" aria-hidden="true">#</a> 饮料</h2>
<p>现磨咖啡味道不错，每天用量需控制在 2 杯黑咖啡或 4 杯奶咖，相关数据参考<a href="https://www.zhihu.com/question/546343871/answer/2692019428" target="_blank" rel="noopener noreferrer">适量喝咖啡对身体有哪些好处？<ExternalLinkIcon/></a>。有时喝的频繁就比较折腾，考虑入手白咖啡，不过据传白咖啡糖分高，而且含反式脂肪酸。</p>
<blockquote>
<p>马来西亚的土特产，约有 100 多年的历史。白咖啡并不是指咖啡的颜色是白色的，而是采用特等 Liberia（利比里亚）、Arabica（阿拉比卡）和 Robusta（罗布斯塔）咖啡豆及特级的脱脂奶精原料，经中轻度低温烘焙及特殊工艺加工后大量去除咖啡碱，去除高温碳烤所产生的焦苦与酸涩味，将咖啡的苦酸味、咖啡因含量降到最低，甘醇芳香不伤肠胃，保留咖啡原有的色泽和香味，口感爽滑、纯正，颜色比普通奶咖更清淡柔和，呈现出淡淡的奶金黄色。</p>
</blockquote>
<p>夏天喝适合冷泡的绿茶、红茶、白茶、花茶等，而岩茶与普洱生茶冷泡就不容易好喝。<sup class="footnote-ref"><a href="#footnote1">[1]</a><a class="footnote-anchor" id="footnote-ref1" /></sup> 蛮喜欢泰厨的花茶，有新鲜的香茅，但淘宝卖的花茶放了很多糖块。</p>
<h2 id="零食" tabindex="-1"><a class="header-anchor" href="#零食" aria-hidden="true">#</a> 零食</h2>
<ul>
<li>炸 (烘烤)：烘烤预热－200 度，20 分钟，芝士鸡排 (胖)&gt; 泰森上校鸡块&gt; 鸡米花，炸鸡排、牛肉馅饼外面有面粉，不适合烘烤。</li>
<li>安井肉丸：撒尿牛肉丸&gt; 包心鱼丸&gt; 仿墨鱼丸？&gt;牛肉丸&gt; 蟹味宝 + 鱼籽包。安井肉丸质量都不错，不过别买量贩装，这是不同种类。</li>
</ul>
<h2 id="程序员延寿指南" tabindex="-1"><a class="header-anchor" href="#程序员延寿指南" aria-hidden="true">#</a> 程序员延寿指南</h2>
<p><a href="https://github.com/geekan/HowToLiveLonger" target="_blank" rel="noopener noreferrer">程序员延寿指南<ExternalLinkIcon/></a>:</p>
<ul>
<li>输入
<ul>
<li>固体：<a href="https://github.com/geekan/HowToLiveLonger#611-%E5%9B%BA%E4%BD%93" target="_blank" rel="noopener noreferrer">吃白肉<ExternalLinkIcon/></a>（-11%~-3% ACM）、蔬果为主（-26%~-17% ACM），多吃辣（-23% ACM），多吃坚果（-27%~-4% ACM），少吃蛋黄（否则 +7% ACM/0.5 颗/天），中量碳水、多吃植物蛋白（-10% ACM），少吃超加工食物（-62%~-18%）</li>
<li>液体：喝咖啡（-22%~-12% ACM），<strong>喝牛奶</strong>（-17%~-10% ACM），喝茶（-15%~-8% ACM），少喝或不喝甜味饮料（否则每天一杯 +7% ACM，+多巴胺），戒酒或每周 100g（纯酒精量 (g)=饮酒量 (ml)× 酒精浓度 (%)× 酒精密度 0.8g/ml）内（否则+~50% ACM，无上限）</li>
<li>气体：不吸烟（否则+~50% ACM，-12~-11 年寿命）</li>
<li>光照：<a href="https://github.com/geekan/HowToLiveLonger#614-%E5%85%89%E7%85%A7" target="_blank" rel="noopener noreferrer">晒太阳<ExternalLinkIcon/></a>（-~40% ACM）</li>
<li>药物：二甲双胍（糖尿病人相比正常人可以 +3 年）、复合维生素（-8% 癌症风险）、亚精胺（-60%~-30% ACM）、葡萄糖胺（-39% ACM）</li>
</ul>
</li>
<li>输出
<ul>
<li>运动：每周 3 次 45 分钟挥拍运动（-47% ACM）</li>
<li>日常：刷牙（-25% ACM）</li>
<li>睡眠：每天睡 7 小时全因死亡率最低；且 22-24 点间最好，<em>早睡 +43% ACM，晚睡 +15% ACM（存在争议）</em></li>
</ul>
</li>
<li>上下文
<ul>
...
<p>在发表在《细胞》杂志的<a href="https://www.cell.com/cell/fulltext/S0092-8674(22)00398-1" target="_blank" rel="noopener noreferrer">综述文章<ExternalLinkIcon/></a>中描述了<a href="https://news.sciencenet.cn/htmlnews/2022/4/478234.shtm" target="_blank" rel="noopener noreferrer">长寿饮食<ExternalLinkIcon/></a>，这是一种基于从食物成分和卡路里摄入等饮食各个方面研究的多支柱方法。研究人员报告说，理想情况下，一天的饭菜都在 11—12 小时的窗口内进行，允许每天禁食，每 3—4 个月进行为期 5 天的禁食也可能有助于降低胰岛素抵抗、血压和其他疾病风险因素。朗格描述了长寿饮食在现实生活中的样子：大量的豆类、全谷物和蔬菜；一些鱼;没有红肉或加工肉和极少量的白肉；低糖和精制谷物；一定量的坚果和橄榄油；一些黑巧克力。</p>
<h2 id="泡澡" tabindex="-1"><a class="header-anchor" href="#泡澡" aria-hidden="true">#</a> 泡澡</h2>
<p>浸泡 42℃ 以上的水温最多泡 3-5 分钟，40℃ 可以泡 10 分钟，37℃ 到 39℃ 的温水，可以泡 20-30 分钟。</p>
<p>泡浴后的清水冲淋是有必要的，头发部位和面部用冷水冲淋则有极其良好的保健和延缓衰老的功效。</p>
<p>泡浴作用：</p>
<ul>
<li>低温、长时间的泡浴 - 失眠、压力带来的疲劳。</li>
<li>上班前或者重大活动前高温或者低温并且短时间的泡浴 - 打起精神。</li>
<li>0-21°，收敛组织器官和神经系统--冷水浴。</li>
<li>32-40°，舒缓、愉快 - 温水浴。</li>
<li>32-42°，止痛、镇静，浴后无力需要休息 - 热水浴。</li>
<li>全身浴：覆盖肩膀为主，温水 - 提高新陈代谢。</li>
<li>半身浴：肚脐平齐，不增加心脏负担，30-40 分钟，慢慢发汗，上半身披毛巾或间断性加水 - 改善心脏功能，改善冷性体质，特别适合老年人。注意：<strong>39°，肚脐，30 分钟以上</strong>。</li>
<li>坐浴：20 厘米高度的水平线，浸入腰椎、尾椎、臀部，15 分钟 - 痔疮、便秘、尿路感染、生殖系统护理。</li>
</ul>
<p>另外，饮酒后最好不要立即去洗澡，这很容易引发心血管病。洗澡时出现头晕、胸闷、眼花等“澡堂综合征”，也需立即停浴，到医院就诊。</p>
<h2 id="减肥食谱" tabindex="-1"><a class="header-anchor" href="#减肥食谱" aria-hidden="true">#</a> 减肥食谱</h2>
...
<li id="footnote1" class="footnote-item"><p><a href="https://www.guokr.com/article/461818/" target="_blank" rel="noopener noreferrer">冷泡茶和热茶放凉，好喝级别能一样吗？<ExternalLinkIcon/></a> <a href="#footnote-ref1" class="footnote-backref">↩︎</a></p>
</li>
</ol>
</section>
</div></template>
