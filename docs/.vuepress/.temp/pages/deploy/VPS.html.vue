...
<p>有些静态文件不支持直接打开，需要架构本地服务器来进行测试。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="网站字体" tabindex="-1"><a class="header-anchor" href="#网站字体" aria-hidden="true">#</a> 网站字体</h2>
...
<h2 id="米拓" tabindex="-1"><a class="header-anchor" href="#米拓" aria-hidden="true">#</a> 米拓</h2>
<ul>
...
<h2 id="服务器-ecs" tabindex="-1"><a class="header-anchor" href="#服务器-ecs" aria-hidden="true">#</a> 服务器 ECS</h2>
<p>服务器系统为 Debian 11。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="网站重定向" tabindex="-1"><a class="header-anchor" href="#网站重定向" aria-hidden="true">#</a> 网站重定向</h3>
<p>更改 nginx 配置后，nginx 重载配置后实现网站重定向。<code v-pre>$1</code> 表示第一个 <code v-pre>()</code> 内的正则匹配内容，<code v-pre>$2</code> 为第二个。<sup class="footnote-ref"><a href="#footnote1">[1]</a><a class="footnote-anchor" id="footnote-ref1" /></sup></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="cors-跨域" tabindex="-1"><a class="header-anchor" href="#cors-跨域" aria-hidden="true">#</a> CORS 跨域</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="数据库出错解决" tabindex="-1"><a class="header-anchor" href="#数据库出错解决" aria-hidden="true">#</a> 数据库出错解决</h3>
<ol>
<li>mysql 配置中 <code v-pre>mysqld</code> 在一行添加 <code v-pre>innodb_force_recovery=4</code>，数值可以 0-6，数值越大对数据库损害越大。正常启动 mysql 后，备份所有数据库和管理密码，并下载到本地。</li>
<li>在宝塔的「数据库」中删除所有数据库，卸载并重装 mysql。</li>
<li>重新导入数据库。</li>
</ol>
<h3 id="piwik-手动升级" tabindex="-1"><a class="header-anchor" href="#piwik-手动升级" aria-hidden="true">#</a> piwik 手动升级</h3>
...
<li id="footnote1" class="footnote-item"><p><a href="https://www.w3cschool.cn/nginxsysc/nginxsysc-rewrite.html" target="_blank" rel="noopener noreferrer">Nginx rewrite 设置<ExternalLinkIcon/></a> <a href="#footnote-ref1" class="footnote-backref">↩︎</a></p>
</li>
</ol>
</section>
</div></template>
