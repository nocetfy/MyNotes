<template><div><p>AutoHotkey 是 Windows 平台下开源的热键脚本语言。AHK 学习门槛不高，初期可以通过脚本录制来完成，我通过 AHK 热键启动、定时判断、改键盘等多种自动化操作，推荐学习制作你的专属自动化脚本。</p>
<ul>
<li><a href="https://wyagd001.github.io/zh-cn/docs/AutoHotkey.htm" target="_blank" rel="noopener noreferrer">AutoHotkey 中文说明<ExternalLinkIcon/></a>：<a href="https://wyagd001.github.io/zh-cn/docs/commands/Send.htm#keynames" target="_blank" rel="noopener noreferrer">按键 Key 名列表<ExternalLinkIcon/></a>，<a href="https://wyagd001.github.io/zh-cn/docs/Variables.htm#OSVersion" target="_blank" rel="noopener noreferrer">AHK 环境变量<ExternalLinkIcon/></a></li>
<li>脚本录制/功能编辑：<a href="https://www.macrocreator.com/download/" target="_blank" rel="noopener noreferrer">Pulover's Macro Creator<ExternalLinkIcon/></a>，<a href="https://github.com/papple23g/ahkcompiler" target="_blank" rel="noopener noreferrer">AutoHotkey 語法產生器 (線上網站)<ExternalLinkIcon/></a></li>
</ul>
<table>
<thead>
<tr>
...
<tr>
<td>`</td>
<td>转义字符，参考<a href="https://wyagd001.github.io/zh-cn/docs/misc/EscapeChar.htm" target="_blank" rel="noopener noreferrer">转义序列<ExternalLinkIcon/></a></td>
</tr>
<tr>
<td>;</td>
<td>代表注释内容，不影响函数</td>
...
<ul>
<li>AHK 中<strong>不区分大小写</strong>，即 run 和 RUN 没有区别。</li>
<li>非热键情况，添加 <code v-pre>return</code>，脚本全部停止。</li>
<li>脚本需考虑，你是想要在<strong>全局</strong>还是<strong>局部</strong>中激活动作。</li>
</ul>
<h2 id="常用方法" tabindex="-1"><a class="header-anchor" href="#常用方法" aria-hidden="true">#</a> 常用方法</h2>
<h3 id="托盘图标" tabindex="-1"><a class="header-anchor" href="#托盘图标" aria-hidden="true">#</a> 托盘图标</h3>
<p>自定义图标可使用 ico 或 png，不支持 svg 格式。</p>
<p>托盘图标设置命令为 <code v-pre>Menu, Tray, Icon, %A_WorkingDir%\dock_panel.png</code>。<code v-pre>%A_WorkingDir%</code> 代表脚本所在目录。</p>
<p>如果是设置 exe 程序图标，则使用 <a href="https://github.com/AutoHotkey/Ahk2Exe/releases" target="_blank" rel="noopener noreferrer">Ahk2Exe<ExternalLinkIcon/></a> 工具手动转换。</p>
<h3 id="执行-powershell" tabindex="-1"><a class="header-anchor" href="#执行-powershell" aria-hidden="true">#</a> 执行 PowerShell</h3>
<p>系统级别的操作可以通过 <a href="https://learn.microsoft.com/zh-cn/powershell/scripting/learn/ps101/01-getting-started" target="_blank" rel="noopener noreferrer">PowerShell<ExternalLinkIcon/></a> 来实现。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># Run, powershell.exe -NoExit -Command &amp;{命令}, 目录</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="问题" tabindex="-1"><a class="header-anchor" href="#问题" aria-hidden="true">#</a> 问题</h2>
<h3 id="激发热键后按键未释放" tabindex="-1"><a class="header-anchor" href="#激发热键后按键未释放" aria-hidden="true">#</a> 激发热键后按键未释放</h3>
<p><code v-pre>Send, ^!+w</code> 指代热键 <code v-pre>Ctrl+Alt+Shift+W</code>，有时辅助热键未正确释放，会导致激发热键后输入有问题。</p>
<p>函数结尾加一行 <code v-pre>Send, {Ctrl up}{Alt up}{Shift up}</code> 即可解决该问题。</p>
<h3 id="隐藏在托盘程序无法监测" tabindex="-1"><a class="header-anchor" href="#隐藏在托盘程序无法监测" aria-hidden="true">#</a> 隐藏在托盘程序无法监测</h3>
<p><code v-pre>WinExist</code> 只能查看签订程序，对于后台或托盘程序，可以用 Process 命令来检查是否存在指定程序的 PID。</p>
<div class="language-autohotkey line-numbers-mode" data-ext="autohotkey"><pre v-pre class="language-autohotkey"><code><span class="token comment">;晚上8点停止录屏，并精简视频</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="命令中的按键未执行" tabindex="-1"><a class="header-anchor" href="#命令中的按键未执行" aria-hidden="true">#</a> 命令中的按键未执行</h3>
<p>如果 AutoHotkey 脚本中模拟了按键，窗口中却并未执行，则尝试用管理员权限执行脚本。</p>
<p>低权限的窗口/进程不能发送消息到高权限窗口。比如 Quicker 窗口的权限高，普通启动的 AutoHotkey 脚本无法对 Quicker 输入模拟键，需要管理员权限。</p>
<h3 id="管理员权限运行脚本" tabindex="-1"><a class="header-anchor" href="#管理员权限运行脚本" aria-hidden="true">#</a> 管理员权限运行脚本</h3>
<p>如果<strong>管理员密码为空</strong>，则参考 <a href="http://www.ujiaoshou.com/xtjc/155215500.html" target="_blank" rel="noopener noreferrer">Win10 添加开机启动项管理员权限运行如何设置<ExternalLinkIcon/></a>，在系统的任务计划程序添加管理员自启动。如果想避免启动报错，建议将启动触发器从「开机」改成「登录」，增加延迟 1 分钟，勾选「最高管理员权限」。设置后，脚本中的打开命令都将使用管理员权限执行。</p>
<p>另一种启动方式，右键单击脚本的快捷方式，选择「属性」&gt;「高级」，勾选「用管理员身份运行」，只能用于手动开启，开机启动会忽略带管理器的启动项。</p>
<p><strong>管理员有设密码</strong>，则可使用下列命令，用管理员权限打开脚本。</p>
<div class="language-autohotkey line-numbers-mode" data-ext="autohotkey"><pre v-pre class="language-autohotkey"><code><span class="token command selector">RunAs</span><span class="token punctuation">,</span> Administrator<span class="token punctuation">,</span> PassWD
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="常用函数" tabindex="-1"><a class="header-anchor" href="#常用函数" aria-hidden="true">#</a> 常用函数</h2>
<h3 id="命令-run-msgbox-send" tabindex="-1"><a class="header-anchor" href="#命令-run-msgbox-send" aria-hidden="true">#</a> 命令：run, msgbox, send</h3>
<div class="language-autohotkey line-numbers-mode" data-ext="autohotkey"><pre v-pre class="language-autohotkey"><code><span class="token comment">;run 运行程序或者文档或其他</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="局部变量-ifwinactive" tabindex="-1"><a class="header-anchor" href="#局部变量-ifwinactive" aria-hidden="true">#</a> 局部变量：IFwinactive</h3>
<p>注意：同样<strong>不区分大小写</strong>。比如 ifwinactive 等等。</p>
<div class="language-autohotkey line-numbers-mode" data-ext="autohotkey"><pre v-pre class="language-autohotkey"><code><span class="token comment">;#IFwinactive（指定窗口）（热键或热字串）</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="热键、热字串" tabindex="-1"><a class="header-anchor" href="#热键、热字串" aria-hidden="true">#</a> 热键、热字串</h2>
<h3 id="热键-按键-1-按键-2" tabindex="-1"><a class="header-anchor" href="#热键-按键-1-按键-2" aria-hidden="true">#</a> 热键：(按键 1)(按键 2)</h3>
<p>当按下特定的按键，或者按键顺序，或者按键组合时，激活某个或者某系列动作。</p>
<div class="language-autohotkey line-numbers-mode" data-ext="autohotkey"><pre v-pre class="language-autohotkey"><code><span class="token directive important">#q</span><span class="token punctuation">:</span><span class="token punctuation">:</span> <span class="token comment">;按下 win 键和 q 键时激活运行记事本这个动作。</span>
...
<p>扩展或者说自动替换文本，当然也可以映射任何脚本动作。</p>
<p>自动替换：</p>
<div class="language-autohotkey line-numbers-mode" data-ext="autohotkey"><pre v-pre class="language-autohotkey"><code><span class="token punctuation">:</span><span class="token punctuation">:</span>hay<span class="token punctuation">:</span><span class="token punctuation">:</span>how are you<span class="token operator">?</span> <span class="token comment">;当输入 hay 时自动替换为 how are you？</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>热字串映射脚本：</p>
<div class="language-autohotkey line-numbers-mode" data-ext="autohotkey"><pre v-pre class="language-autohotkey"><code><span class="token punctuation">:</span><span class="token punctuation">:</span>np<span class="token punctuation">:</span><span class="token punctuation">:</span>
...
好久不见！
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>键入热字串后，再加<strong>空格</strong>、或 <strong>tab</strong>、或<strong>回车</strong>，就可以触发缩写。</p>
<h2 id="ahk-使用样例" tabindex="-1"><a class="header-anchor" href="#ahk-使用样例" aria-hidden="true">#</a> AHK 使用样例</h2>
<h3 id="神速激活-打开-隐藏程序" tabindex="-1"><a class="header-anchor" href="#神速激活-打开-隐藏程序" aria-hidden="true">#</a> 神速激活/打开/隐藏程序</h3>
<p><code v-pre>Win+C</code>激活 Chrome 状态切换：Chrome 没打开时 --&gt; 打开；打开没激活状态时候 --&gt; 激活；打开处在激活状态时候 ---&gt; 隐藏。<sup class="footnote-ref"><a href="#footnote1">[1]</a><a class="footnote-anchor" id="footnote-ref1" /></sup></p>
<div class="language-autohotkey line-numbers-mode" data-ext="autohotkey"><pre v-pre class="language-autohotkey"><code><span class="token directive important">#c</span><span class="token punctuation">:</span><span class="token punctuation">:</span>
...
<span class="token punctuation">}</span>
<span class="token command selector">Return</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="一键运行-关闭脚本的循环" tabindex="-1"><a class="header-anchor" href="#一键运行-关闭脚本的循环" aria-hidden="true">#</a> 一键运行/关闭脚本的循环</h3>
<p>按 F2 一键运行/关闭脚本的循环，空格可暂停/继续脚本。</p>
<div class="language-autohotkey line-numbers-mode" data-ext="autohotkey"><pre v-pre class="language-autohotkey"><code><span class="token directive important">#maxThreadsPerHotkey</span><span class="token punctuation">,</span> <span class="token number">2</span> <span class="token comment">;让热键能同时有运行/关闭作用，否则键击会被忽略</span>
...
<p>监测应用是否有运行，如果没运行则执行启动热键。</p>
<div class="language-autohotkey line-numbers-mode" data-ext="autohotkey"><pre v-pre class="language-autohotkey"><code><span class="token command selector">Process</span><span class="token punctuation">,</span> <span class="token keyword">Exist</span><span class="token punctuation">,</span> PicGo<span class="token operator">.</span>exe
...
<span class="token punctuation">}</span>
<span class="token command selector">return</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="输入法状态影响字符输出" tabindex="-1"><a class="header-anchor" href="#输入法状态影响字符输出" aria-hidden="true">#</a> 输入法状态影响字符输出</h3>
<p>在脚本中，调用函数<code v-pre>SendText()</code>输出文字，不受输入法状态。</p>
<div class="language-autohotkey line-numbers-mode" data-ext="autohotkey"><pre v-pre class="language-autohotkey"><code><span class="token comment">;;;;;;;新版独立小程序，可以避免输入法状态影响中文或英文字符的热键输出;;;;;;;</span>
...
<span class="token function">SendText</span><span class="token punctuation">(</span>var_string<span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token command selector">return</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="大写键改为-enter" tabindex="-1"><a class="header-anchor" href="#大写键改为-enter" aria-hidden="true">#</a> 大写键改为 Enter</h3>
<div class="language-autohotkey line-numbers-mode" data-ext="autohotkey"><pre v-pre class="language-autohotkey"><code><span class="token comment">;replace CapsLock to LeftEnter; CapsLock = Alt CapsLock</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr class="footnotes-sep">
<section class="footnotes">
<ol class="footnotes-list">
<li id="footnote1" class="footnote-item"><p><a href="https://segmentfault.com/a/1190000004611125" target="_blank" rel="noopener noreferrer">Win 下最爱效率利器:AutoHotKey<ExternalLinkIcon/></a> <a href="#footnote-ref1" class="footnote-backref">↩︎</a></p>
</li>
</ol>
</section>
</div></template>
