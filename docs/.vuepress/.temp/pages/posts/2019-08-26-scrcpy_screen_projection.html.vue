<template><div><p><a href="https://github.com/Genymobile/scrcpy" target="_blank" rel="noopener noreferrer">scrcpy<ExternalLinkIcon/></a> 是一款免费开源的投屏软件，可以将安卓手机屏幕投放在 Windows、macOS、GNU/Linux 上，并可以直接使用鼠标在投屏窗口中进行交互和录制。</p>
<p>市面上主流的多屏协同软件大多都是基于 scrcpy 开发的套壳产品，而且 bug 也没有得到修复，因此建议直接使用官方的 scrcpy。</p>
<p>本文以 Windows 投屏为例，可以前往官方站点下载 <a href="https://github.com/Genymobile/scrcpy/releases/download/v1.25/scrcpy-win64-v1.25.zip" target="_blank" rel="noopener noreferrer">scrcpy-win64-v1.25.zip<ExternalLinkIcon/></a>，或者使用<a href="https://wwva.lanzoue.com/iHnRJ0jm0uhe" target="_blank" rel="noopener noreferrer">国内搬运链接<ExternalLinkIcon/></a>。</p>
<h2 id="有线投屏" tabindex="-1"><a class="header-anchor" href="#有线投屏" aria-hidden="true">#</a> 有线投屏</h2>
<ol>
<li>下载并解压 scrcpy。</li>
<li>手机端开启 <code v-pre>开发者选项</code> 和 <code v-pre>USB 调试</code>。开发者选项默认处于隐藏状态，手机上选择「设置」&gt;「关于手机」，然后点击版本号七次，返回上一屏幕，即可在底部找到开发者选项。</li>
<li>使用数据线将手机和电脑连接，此时手机上会弹出授权提示，点击「允许 USB 调试」。</li>
<li>双击解压得到的 scrcpy.exe 文件，即可进行有线投屏。</li>
</ol>
<h2 id="无线投屏" tabindex="-1"><a class="header-anchor" href="#无线投屏" aria-hidden="true">#</a> 无线投屏</h2>
<p>无线投屏的前提是，电脑和手机处于<strong>同一局域网</strong>中。</p>
<p>有线投屏中的前三步也适用于无线投屏，完成这些步骤后，打开 PowerShell（~ cmd），依次输入操作命令。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># a.将命令目录切换到 scrcpy 文件夹。如果使用的是 Windows 11，在 scrcpy 文件夹中右键点击「在终端中打开」，会自动切换到当前路径。</span>
<span class="token builtin class-name">cd</span> D:<span class="token punctuation">\</span>Libraries<span class="token punctuation">\</span>Desktop<span class="token punctuation">\</span>scrcpy-win64-v1.25
​
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 将命令目录切换到 scrcpy 文件夹。</span>
<span class="token builtin class-name">cd</span> D:<span class="token punctuation">\</span>Libraries<span class="token punctuation">\</span>Desktop<span class="token punctuation">\</span>scrcpy-win64-v1.25
​
...
<h3 id="错误检查" tabindex="-1"><a class="header-anchor" href="#错误检查" aria-hidden="true">#</a> 错误检查</h3>
...
<h3 id="error-exception-on-thread" tabindex="-1"><a class="header-anchor" href="#error-exception-on-thread" aria-hidden="true">#</a> ERROR: Exception on thread</h3>
<p>报错 <code v-pre>ERROR: Exception on thread Thread[main,5,main]</code>，通常是因为手机不兼容 scrcpy 默认的分辨率设置。解决方法是，修改 scrcpy 启动代码，使用较低的分辨率。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 三个分辨率设置，任选其一。</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="华为不能投屏" tabindex="-1"><a class="header-anchor" href="#华为不能投屏" aria-hidden="true">#</a> 华为不能投屏</h3>
...
<h3 id="投屏模糊" tabindex="-1"><a class="header-anchor" href="#投屏模糊" aria-hidden="true">#</a> 投屏模糊</h3>
...
<p>更多问题报错的解决方法，可以查看 <a href="https://github.com/Genymobile/scrcpy/blob/master/FAQ.md" target="_blank" rel="noopener noreferrer">scrcpy FAQ<ExternalLinkIcon/></a>。</p>
</div></template>
