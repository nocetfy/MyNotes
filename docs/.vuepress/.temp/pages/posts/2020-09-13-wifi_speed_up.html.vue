<template><div><p>拖慢 WIFI 速度的最大元凶是<strong>无线信号合并</strong>。</p>
...
<h2 id="无线模式" tabindex="-1"><a class="header-anchor" href="#无线模式" aria-hidden="true">#</a> 无线模式</h2>
...
<h2 id="频道带宽" tabindex="-1"><a class="header-anchor" href="#频道带宽" aria-hidden="true">#</a> 频道带宽</h2>
...
<h2 id="调整信道" tabindex="-1"><a class="header-anchor" href="#调整信道" aria-hidden="true">#</a> 调整信道</h2>
