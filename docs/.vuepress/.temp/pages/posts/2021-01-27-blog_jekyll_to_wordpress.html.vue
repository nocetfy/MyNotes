<template><div><p>2005 年开始在 MSN space 写博客，期间配合 Google Sidewiki(短命) 记录感想。六年后，MSN space 关闭，旧博客被动转移到 WordPress 托管，暂停使用博客。</p>
...
<h2 id="迁移步骤" tabindex="-1"><a class="header-anchor" href="#迁移步骤" aria-hidden="true">#</a> 迁移步骤</h2>
<p>这里迁移的是 Jekyll 的 <a href="https://github.com/Huxpro/huxpro.github.io" target="_blank" rel="noopener noreferrer">Hux blog 模板<ExternalLinkIcon/></a>，Hexo 或其他 Jekyll 博客可以参照微调。</p>
<ol>
<li>
<p>复制博客主目录下的 feed.xml 文件，重命名为「feed-wp.xml」。如果目录内不存在 feed.xml，可尝试 rss.xml 或 atom.xml。</p>
</li>
<li>
<p>修改 feed-wp.xml 文件中的 <code v-pre>for post in site.posts limit:100 %</code>，该项为 rss 最低生成量，我们导出所有文章，因此将该值修改为 100。</p>
</li>
<li>
<p>参照下方内容，按 WordPress 所需 rss 格式修改 feed-wp.xml 文件的 <code v-pre>item</code> 部分，并在文件顶部的 <code v-pre>&lt;rss&gt;</code> 元素内添加 <code v-pre>xmlns:content=&quot;http://purl.org/rss/1.0/modules/content/&quot;</code>，避免 xml 格式报错。</p>
...
<li>
<p>后台－Syndication－添加 rss 源，比如添加源 <code v-pre>xxx.com/feed-wp.xml</code>，其中 <code v-pre>xxx.com</code> 指你的博客网址。</p>
...
<ul>
<li>
<p><a href="https://www.v2ex.com/t/73385" target="_blank" rel="noopener noreferrer">有没有办法把 Markdown 写的博客迁移到 wordpress？<ExternalLinkIcon/></a></p>
</li>
<li>
<p><a href="https://www.yiyult.com/201903155699.html" target="_blank" rel="noopener noreferrer">WordPress 从 RSS 导入文章<ExternalLinkIcon/></a></p>
</li>
<li>
<p><a href="https://www.cnblogs.com/u0mo5/p/4100927.html" target="_blank" rel="noopener noreferrer">有关 WordPress 的 Rss 导入指南<ExternalLinkIcon/></a></p>
</li>
<li>
<p><a href="https://stackoverflow.com/questions/33212592/how-to-create-contentencoded-in-rss" target="_blank" rel="noopener noreferrer">How to create <a href="content:encoded">content:encoded<ExternalLinkIcon/></a> in RSS</a></p>
</li>
</ul>
</div></template>
