...
<h2 id="安装-ui-vision" tabindex="-1"><a class="header-anchor" href="#安装-ui-vision" aria-hidden="true">#</a> 安装 UI.Vision</h2>
<p>UI.Vision RPA 的主体是浏览器插件，只需去应用商店即可完成安装。</p>
<ul>
<li>Chrome 插件：<a href="https://chrome.google.com/webstore/detail/uivision-rpa/gcbalfbdmfieckjlnblleoemohcganoc" target="_blank" rel="noopener noreferrer">https://chrome.google.com/webstore/detail/uivision-rpa/gcbalfbdmfieckjlnblleoemohcganoc<ExternalLinkIcon/></a></li>
<li>Firefox 插件：<a href="https://addons.mozilla.org/zh-CN/firefox/addon/rpa/" target="_blank" rel="noopener noreferrer">https://addons.mozilla.org/zh-CN/firefox/addon/rpa/<ExternalLinkIcon/></a></li>
<li>Edge 插件：<a href="https://microsoftedge.microsoft.com/addons/detail/uivision-rpa-%E6%B5%8F%E8%A7%88%E5%99%A8%E8%87%AA%E5%8A%A8%E5%8C%96%E5%B7%A5%E5%85%B7/goapmjinbaeomoemgdcnnhoedopjnddd" target="_blank" rel="noopener noreferrer">https://microsoftedge.microsoft.com/addons/detail/uivision-rpa-浏览器自动化工具/goapmjinbaeomoemgdcnnhoedopjnddd<ExternalLinkIcon/></a></li>
</ul>
<h2 id="零门槛入门" tabindex="-1"><a class="header-anchor" href="#零门槛入门" aria-hidden="true">#</a> 零门槛入门</h2>
...
<h2 id="第一次使用" tabindex="-1"><a class="header-anchor" href="#第一次使用" aria-hidden="true">#</a> 第一次使用</h2>
...
<h2 id="不同变量重复运行" tabindex="-1"><a class="header-anchor" href="#不同变量重复运行" aria-hidden="true">#</a> 不同变量重复运行</h2>
<p>用不同的变量文本进行重复的网页操作，需要使用 UI.Vision 的 <a href="https://ui.vision/rpa/docs/selenium-ide/csvread" target="_blank" rel="noopener noreferrer">csvRead<ExternalLinkIcon/></a> 命令。下面以「依次打开不同链接」为例。</p>
<ol>
<li>点击 UI.Vision 右下角的「CSV」&gt;「Import CSV」，用 CSV 文件导入批量处理内容。</li>
<li>使用「csvReadArray」命令，Target 输入文件名「1.csv」，Value 输入分组名「link」。</li>
<li>使用「executeScript」命令，Target 输入计算脚本 <code v-pre>return ${!LOOP} - 1;</code>，Value 输入自定义变量名 <code v-pre>num</code>。数组序号以 0 开始而循环序号 <code v-pre>${!LOOP}</code> 以 1 起始，所以数组序号为 <code v-pre>${!LOOP}-1</code>。</li>
<li>使用「open」命令，Target 输入变量参数 <code v-pre>${link[${num}]}</code>，<code v-pre>${link[x]}</code> 指 link 数组中序号为 x 的成员。</li>
...
<h3 id="录制脚本无法使用" tabindex="-1"><a class="header-anchor" href="#录制脚本无法使用" aria-hidden="true">#</a> 录制脚本无法使用</h3>
<p>如果脚本中使用了热键，这是无法被录制的，需要你手工添加 <code v-pre>XType</code> 命令。</p>
<p>如果脚本点击不成功，可以将对映步骤的 <code v-pre>Click</code> 命令改为 <code v-pre>XClick</code>。</p>
<h3 id="浏览器外使用-rpa" tabindex="-1"><a class="header-anchor" href="#浏览器外使用-rpa" aria-hidden="true">#</a> 浏览器外使用 RPA</h3>
<ol>
<li>地址栏输入 <code v-pre>chrome://extensions/</code>，找到扩展 UI.Vision RPA，点击按钮「详情」，启用「允许访问文件网址」。</li>
<li>右键单击指定脚本，点击「Create autorun HTML」，将自动输出两个 html 文件。</li>
<li>点击与脚本同名的 html 即可启动脚本。</li>
</ol>
<h3 id="本地运行自动化报错" tabindex="-1"><a class="header-anchor" href="#本地运行自动化报错" aria-hidden="true">#</a> 本地运行自动化报错</h3>
<p>本地运行自动化文件，报错 <code v-pre>No tab with id</code>。</p>
<p>这是自动化内存泄漏造成的报错，需要手动点击右上角的「Play Macro」按钮执行命令。
如果你不想手动执行，可以用编辑器打开与脚本同名的 html 文件，找到 <code v-pre>href=&quot;ui.vision.html?direct=1</code>，在这后面加入参数 <code v-pre>&amp;continueInLastUsedTab=0</code>。</p>
...
<ul>
<li><a href="https://www.appinn.com/ui-vision-rpa/" target="_blank" rel="noopener noreferrer">UI.Vision RPA 浏览器自动化工具：表单填写、网页内容抓取、网页操作录制<ExternalLinkIcon/></a></li>
<li><a href="https://ui.vision/rpa/docs/selenium-ide" target="_blank" rel="noopener noreferrer">UI.Vision 命令官方文档<ExternalLinkIcon/></a></li>
<li><a href="https://github.com/LoveOctocat/UI.Vision-Kantu-ZH" target="_blank" rel="noopener noreferrer">白话 UI.Vision Kantu 插件<ExternalLinkIcon/></a></li>
</ul>
</div></template>
