<template><div><p>疫情封控两个月后，人变得愈发懒散，每天的成果只有吃饭睡觉。为了摆脱这种状态，我决定在书房对自己进行 24 小时的监控录像，督促自己提升效率。</p>
...
<h2 id="自我监控方案" tabindex="-1"><a class="header-anchor" href="#自我监控方案" aria-hidden="true">#</a> 自我监控方案</h2>
<ol>
<li><strong>晨间唤醒</strong>：起床后，用手机单独录一句话。这句话在前一天准备好，包括日期、当日目标，也可以引入美好的回忆、憧憬的未来、向往的地方、喜欢的艺术 (音乐、名画、诗句)。
晨间唤醒参考了<a href="https://www.xuetangx.com/course/THU07111001088/" target="_blank" rel="noopener noreferrer">积极心理学<ExternalLinkIcon/></a>，收集积极情绪材料，给自己创造美好的情绪。</li>
...
<h2 id="监控准备" tabindex="-1"><a class="header-anchor" href="#监控准备" aria-hidden="true">#</a> 监控准备</h2>
...
<h2 id="录制视频-vlc" tabindex="-1"><a class="header-anchor" href="#录制视频-vlc" aria-hidden="true">#</a> 录制视频：VLC</h2>
<p>摄像头录像方案较少，大多是录屏软件的附带功能，我尝试了以下 9 种：</p>
<ul>
<li>相机：Windows 自带应用，录制方便，但输出选项少，限制多。</li>
<li><a href="https://www.flashbackrecorder.com/zh/express/" target="_blank" rel="noopener noreferrer">FlashBack Express<ExternalLinkIcon/></a>：能调节帧率，镜像，虚化背景，但免费版只支持 2 小时内的录制。</li>
<li><a href="https://www.bandicam.cn/" target="_blank" rel="noopener noreferrer">Bandicam<ExternalLinkIcon/></a>：录制时能降噪，内录扬声器音频，自由调节编码、帧率，但免费版只支持录制 10 分钟且有水印，输出文件名自定义规则极少。Bandicam 支持定时录制计划，但录制的开始和结束都必须由该计划执行，否则录制计划将不会执行。比如使用 Bandicam 的开机录制后，定时录制计划就会失效，需借助 Windows 的任务计划程序来定时录制停止，操作参考 <a href="https://www.bandicam.cn/support/tips/timer-recording/" target="_blank" rel="noopener noreferrer">Bandicam 官方文档<ExternalLinkIcon/></a>。</li>
...
<li><a href="https://ohsoft.net/eng/ocam/intro.php?cate=1002" target="_blank" rel="noopener noreferrer">oCam<ExternalLinkIcon/></a>：打着免费招牌但有弹窗广告，且录制视频偏大。</li>
<li><a href="https://getsharex.com/" target="_blank" rel="noopener noreferrer">ShareX<ExternalLinkIcon/></a>：免费开源强大的截图软件，也具备录屏功能，能调节编码和帧率，但只能单一录屏或录像。</li>
<li><a href="https://github.com/MathewSachin/Captura/releases/tag/v8.0.0" target="_blank" rel="noopener noreferrer">Capture<ExternalLinkIcon/></a>：免费开源，使用前需手动 <a href="https://blog.csdn.net/dglx_/article/details/122389601" target="_blank" rel="noopener noreferrer">配置 FFmpeg<ExternalLinkIcon/></a>，自定义叠加元素，但项目已停止更新。测试时，Capture 经常莫名其妙的报错，重启大概率恢复正常，只能偶尔用用，不能用于工作环境。</li>
<li><a href="https://obsproject.com/" target="_blank" rel="noopener noreferrer">OBS<ExternalLinkIcon/></a>：免费开源直播软件，也可以录制视频，操作性极强，但输出限制多，也难以在直播的同时进行桌面录制。</li>
<li><a href="https://www.videolan.org/vlc/" target="_blank" rel="noopener noreferrer">VLC<ExternalLinkIcon/></a>：免费开源视频软件，能调节输出视频的编码、帧率、格式，但操作麻烦，只能单一录屏或录像，暂停录制容易有 bug。</li>
</ul>
...
<ol>
<li>
<p>打开 VLC 的 Media -&gt; Open Capture Device，将 <code v-pre>Video device name</code> 和 <code v-pre>Audio device name</code> 选为摄像头，然后点击底部 <code v-pre>Play</code> 按钮旁边的下拉菜单，选中 <code v-pre>Convert</code>。</p>
<figure><img src="http://tc.seoipo.com/2022-05-21-22-09-08.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</li>
<li>
<p>Settings -&gt; Profile 中选择视频输出方案，推荐选择 <code v-pre>Video - H.264 + MP3 (MP4)</code>，接着点击旁边的扳手按钮，修改输出方案。</p>
...
<h2 id="剪辑视频-dvr-scan" tabindex="-1"><a class="header-anchor" href="#剪辑视频-dvr-scan" aria-hidden="true">#</a> 剪辑视频：DVR-Scan</h2>
<p>过滤视频的静态画面，是监控方案中的核心环节。开始我考虑用 QuickCut 过滤，但它是通过声音来判断视频是否静止（与飞书妙记的「跳过空白片段」原理类似），监控视频中大部分时间是没声音的，不适合用 QuickCut 剪辑。</p>
<p>群里 @chen 推荐了 <a href="https://github.com/Breakthrough/DVR-Scan" target="_blank" rel="noopener noreferrer">DVR-Scan<ExternalLinkIcon/></a>，能从画面判断是否需要过滤。</p>
<blockquote>
...
<p>DVR-Scan 操作很简单，视频目录内右键单击「在终端打开」，执行默认输出命令即可得到过滤后的视频。12 小时的视频，处理用时二十分钟，会占用大量 CPU。有点要注意，DVR-Scan 有个限制，只能导出为<code v-pre>.avi</code>视频。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#默认输出命令，不含音频</span>
...
<p>另外，DVR-Scan 可以使用 <code v-pre>-roi</code> 命令，指定监测区域，只对该区域的动作进行监测。</p>
<p>DVR-Scan 进阶命令查看<a href="https://dvr-scan.readthedocs.io/en/latest/guide/examples/" target="_blank" rel="noopener noreferrer">官方文档<ExternalLinkIcon/></a>。</p>
<h2 id="播放降噪-potplayer" tabindex="-1"><a class="header-anchor" href="#播放降噪-potplayer" aria-hidden="true">#</a> 播放降噪：PotPlayer</h2>
...
<ul>
<li><a href="https://askubuntu.com/questions/422341/how-can-i-detect-motion-in-a-long-mostly-dull-video/423028#423028" target="_blank" rel="noopener noreferrer">How can I detect motion in a long, mostly dull video?<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/NeiHan2020/article/details/118368739" target="_blank" rel="noopener noreferrer">如何设置 potplayer 播放器把人声凸显出来并降噪？<ExternalLinkIcon/></a></li>
<li><a href="https://www.xuetangx.com/course/THU07111001088/" target="_blank" rel="noopener noreferrer">网课：积极心理学<ExternalLinkIcon/></a></li>
</ul>
</div></template>
