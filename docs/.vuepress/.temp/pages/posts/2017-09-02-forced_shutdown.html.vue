<template><div><p>电脑晚上明明按下关机键，第二天早上却发现电脑开了一晚上？</p>
...
<li>
<p>打开窗口后，在注册表上方菜单中输入 <code v-pre>计算机\HKEY_CURRENT_USER\Control Panel\Desktop</code>。</p>
</li>
<li>
<p>在右侧窗格中找到 <code v-pre>AutoEndTasks</code> 键值，如果没有，则新建一个名为 <code v-pre>AutoEndTasks</code> 的「字符串值」，并将键值的数值设为 <code v-pre>1</code>。AutoEndTasks 表示自动结束失去响应的程序任务，0 为 false，是默认值，表示不自动结束失去响应的程序；1 为 true，则表示电脑会自动结束失去响应的程序。</p>
...
<li>
<p>查找或创建字符串值 <code v-pre>WaitToKillAppTimeout</code>，将数值设为 <code v-pre>2000</code>。2000 是毫秒，就是当有没有响应的程序时，等待 2 秒后会自动结束相应程序。</p>
</li>
</ol>
<p>操作下，让电脑默认强制关机吧！</p>
<p>——————————</p>
