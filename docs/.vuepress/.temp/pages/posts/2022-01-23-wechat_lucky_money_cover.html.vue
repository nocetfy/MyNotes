<template><div><p>上海撞上疫情，连续三年春节不能回家，对父母始终有些亏欠。</p>
...
<h2 id="封面平台注册" tabindex="-1"><a class="header-anchor" href="#封面平台注册" aria-hidden="true">#</a> 封面平台注册</h2>
<p>首次使用<a href="https://cover.weixin.qq.com/" target="_blank" rel="noopener noreferrer">微信红包封面开放平台<ExternalLinkIcon/></a>，需要注册并实名认证。如果使用个人身份认证，注册中无付费环节。</p>
...
<h2 id="红包封面设计" tabindex="-1"><a class="header-anchor" href="#红包封面设计" aria-hidden="true">#</a> 红包封面设计</h2>
<p>完成注册环节后，即可定制红包封面。微信提供了 PSD 和  Sketch 的红包封面模板，红包设计可参考<a href="https://cover.weixin.qq.com/cgi-bin/mmcover-bin/readtemplate?t=page/index#/doc?page=design&amp;index=-1" target="_blank" rel="noopener noreferrer">微信红包封面官方文档<ExternalLinkIcon/></a>。</p>
...
<h3 id="封面名称" tabindex="-1"><a class="header-anchor" href="#封面名称" aria-hidden="true">#</a> 封面名称</h3>
<p>红包封面会展示公众号名称和头像，<strong>名称一年可修改两次，头像一个月可申请修改 5 次</strong>。我提交的封面名称与公众号无关，平台并未拒绝。</p>
<h3 id="红包审核" tabindex="-1"><a class="header-anchor" href="#红包审核" aria-hidden="true">#</a> 红包审核</h3>
<p>红包审核需要 3 个工作日。如果审核期间接近放假，建议同时提交三个红包封面，以免到了春节，红包尚未审核通过。</p>
<h3 id="红包图片" tabindex="-1"><a class="header-anchor" href="#红包图片" aria-hidden="true">#</a> 红包图片</h3>
