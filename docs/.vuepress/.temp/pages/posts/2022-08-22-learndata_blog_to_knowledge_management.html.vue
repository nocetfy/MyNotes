<template><div><p>知识管理/笔记软件越来越多，Notion、Obsidian、Logseq、Roam Research、Evernote、flomo、为知、飞书、语雀……我总在不同应用间徘徊。直到有一次，我突然醒悟：知识管理软件不是管理知识，而是管理笔记。<strong>笔记里的知识并不属于你，只有经过消化、应用，才能成为自己的知识。</strong></p>
...
<p>突破迷思后，我基于 VuePress 和 vuepress-theme-hope 建立了 <a href="https://github.com/rockbenben/LearnData" target="_blank" rel="noopener noreferrer">LearnData<ExternalLinkIcon/></a> 项目，将知识笔记、生活记录、博客和任何认为有价值的记录转换为 Markdown 文本，然后推送到 GitHub 生成 Pages 静态页面，并同步到国内云服务器，形成 <a href="https://newzone.top/" target="_blank" rel="noopener noreferrer">LearnData - 开源笔记<ExternalLinkIcon/></a>。</p>
...
<h2 id="为什么用网页管理笔记" tabindex="-1"><a class="header-anchor" href="#为什么用网页管理笔记" aria-hidden="true">#</a> 为什么用网页管理笔记</h2>
<h3 id="公开想法" tabindex="-1"><a class="header-anchor" href="#公开想法" aria-hidden="true">#</a> 公开想法</h3>
...
<h3 id="输出分享" tabindex="-1"><a class="header-anchor" href="#输出分享" aria-hidden="true">#</a> 输出分享</h3>
<p>其次，网页形式使笔记更容易分享。除了效率工具的心得，我还在 LearnData 上放置了生活技巧、购物评价和说明书。当家人或朋友需要帮助时，可以直接访问网页，无需安装应用程序或折腾账户分享，比如我经常分享的<a href="https://newzone.top/family/Maintenance.html#%E9%80%9A%E9%A9%AC%E6%A1%B6" target="_blank" rel="noopener noreferrer">通马桶技巧<ExternalLinkIcon/></a> 和疏通器说明书。</p>
...
<h3 id="被动消化知识" tabindex="-1"><a class="header-anchor" href="#被动消化知识" aria-hidden="true">#</a> 被动消化知识</h3>
...
<h3 id="漂亮决定生产力" tabindex="-1"><a class="header-anchor" href="#漂亮决定生产力" aria-hidden="true">#</a> 漂亮决定生产力</h3>
...
<h2 id="为什么不用-obsidian" tabindex="-1"><a class="header-anchor" href="#为什么不用-obsidian" aria-hidden="true">#</a> 为什么不用 Obsidian</h2>
...
<h2 id="抛弃知识软件-不用" tabindex="-1"><a class="header-anchor" href="#抛弃知识软件-不用" aria-hidden="true">#</a> 抛弃知识软件 ≠ 不用</h2>
...
<h2 id="如果你也想试试" tabindex="-1"><a class="header-anchor" href="#如果你也想试试" aria-hidden="true">#</a> 如果你也想试试……</h2>
<p>如何把博客转换为知识库，建立属于你的 LearnData 知识管理网站？</p>
<p>首先，确保你有 GitHub 账号，懂 Markdown 和基础 HTML 知识。然后，按照 <a href="https://newzone.top/#%F0%9F%94%A3-%E9%85%8D%E7%BD%AE-learndata" target="_blank" rel="noopener noreferrer">LearnData 部署教程<ExternalLinkIcon/></a>完成搭建和配置。如果你的笔记已经用 Markdown 格式编写，只需把文档放在 docs 目录下，就可以建立自己的知识库。</p>
...
<p>如果你有兴趣尝试 <a href="https://newzone.top/" target="_blank" rel="noopener noreferrer">LearnData<ExternalLinkIcon/></a>，欢迎通过链接访问并复制模板尝试。具体的操作方法与常见问答我都写在博客中。如果有进一步的问题或讨论，欢迎在评论区留言。</p>
</div></template>
