<template><div><p>宽带升级到千兆网络后，电信全面更新了光猫，关闭了的光猫管理地址，只能通过官方 APP「网络管家」管理光猫。</p>
<h2 id="电信「网络管家」功能" tabindex="-1"><a class="header-anchor" href="#电信「网络管家」功能" aria-hidden="true">#</a> 电信「网络管家」功能</h2>
<ul>
<li>重启光猫；</li>
<li>开启 UPnp；</li>
...
<h2 id="开启光猫端口映射、内网穿透" tabindex="-1"><a class="header-anchor" href="#开启光猫端口映射、内网穿透" aria-hidden="true">#</a> 开启光猫端口映射、内网穿透</h2>
<ol>
<li>
