<template><div><p>迷上 IFTTT 等自动化应用后，我需要为各种不同的网页定制 RSS 源。其中，最容易入门的工具是 FEED43。本文是一篇介绍如何使用 FEED43 定制 RSS 源的入门指南。</p>
<p><strong>► 开始烧制属于自己的 feed</strong></p>
<h2 id="_1-进入网页" tabindex="-1"><a class="header-anchor" href="#_1-进入网页" aria-hidden="true">#</a> 1. 进入网页</h2>
<p><a href="http://www.feed43.com/" target="_blank" rel="noopener noreferrer">FEED43<ExternalLinkIcon/></a> 不需要注册，点击「Create your own feed」即可使用。</p>
...
<h2 id="_2-选定-rss-网页" tabindex="-1"><a class="header-anchor" href="#_2-选定-rss-网页" aria-hidden="true">#</a> 2. 选定 RSS 网页</h2>
...
<h2 id="_3-定制-rss-抓取规则" tabindex="-1"><a class="header-anchor" href="#_3-定制-rss-抓取规则" aria-hidden="true">#</a> 3. 定制 RSS 抓取规则</h2>
...
<p>测试网址：<code v-pre>http://news.163.com/special/0001386F/rank_whole.html</code>。</p>
<p>需要抓取的源代码：</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>tr</span><span class="token punctuation">></span></span>
...
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>tr</span><span class="token punctuation">></span></span>
  ...
  {*}
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>tr</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>点击 Extract，进行抓取。</p>
...
<h2 id="_4-整理-rss-输入格式" tabindex="-1"><a class="header-anchor" href="#_4-整理-rss-输入格式" aria-hidden="true">#</a> 4. 整理 rss 输入格式</h2>
<p>「Define output format」是 Feed 的属性，通常前三项会被自动抓取一，后三项将之前获取的 item 里面的元素填入即可，<code v-pre>{%1}</code> 对应的是链接，所以填入「Item Link」，<code v-pre>{%2}</code> 对应标题则填入到「Item Title」。</p>
...
<h2 id="_5-获取-rss-地址" tabindex="-1"><a class="header-anchor" href="#_5-获取-rss-地址" aria-hidden="true">#</a> 5. 获取 RSS 地址</h2>
<p>点击 Feed URL 可得 RSS 地址，样例是 <a href="https://www.feed43.com/dianji.xml%E3%80%82" target="_blank" rel="noopener noreferrer">https://www.feed43.com/dianji.xml。<ExternalLinkIcon/></a></p>
...
<h2 id="_6-全文抓取" tabindex="-1"><a class="header-anchor" href="#_6-全文抓取" aria-hidden="true">#</a> 6. 全文抓取</h2>
<p>FEED43 导出的条目需要点击链接才能查看内容。要在 RSS 中展示全文，需要通过 FeedEx 再转换一次。注意：FEED43 免费用户过多，需要在浏览器中打开一次才能获得真实链接（一般为 <code v-pre>http://node2.feed43.com</code>）。FeedEx 需要使用真实链接，一般 3 分钟内转换完毕。</p>
<p>FeedEx: <a href="https://feedex.net/" target="_blank" rel="noopener noreferrer">https://feedex.net/<ExternalLinkIcon/></a></p>
