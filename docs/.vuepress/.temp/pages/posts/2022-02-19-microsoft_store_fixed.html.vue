<template><div><p>Microsoft store 页面无法打开，提示需要联网或刷新。多数教程将原因归咎于系统更新或 DNS 设置，但实际上是你的 <strong>IE 设置被更改了</strong>。</p>
...
<p>如果你依然无法访问，则尝试重置网络连接、DNS、缓存、应用商店设置，操作参考 <a href="https://answers.microsoft.com/zh-hans/windows/forum/all/microsoft/43acd62e-a11e-449c-9fa4-50931ad38565" target="_blank" rel="noopener noreferrer">Microsoft Store 打不开，代码：0x80131500<ExternalLinkIcon/></a>。</p>
<h2 id="解决流程-gif" tabindex="-1"><a class="header-anchor" href="#解决流程-gif" aria-hidden="true">#</a> 解决流程 GIF</h2>
